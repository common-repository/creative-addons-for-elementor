jQuery(document).ready(function($) {
	...
	// Clear all active classes of info icon.
	$(document).on( 'click', function(){
		$('.crel-list-item').removeClass('crel-list-item--active-desc');
	});

	$(document).on( 'click', '.crel-list-item__header__info', function(){
		$('.crel-list-item').removeClass('crel-list-item--active-desc');
		$(this).closest('.crel-list-item').addClass('crel-list-item--active-desc');
		return false;
	});

	$(document).on( 'click', '.crel-list-item__body', function(e){
		e.stopPropagation();
	});
});
