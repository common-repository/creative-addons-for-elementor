...
class Text_Image extends Creative_Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Text and Image', 'creative-addons-for-elementor' );
	}
	...
	protected function get_config_defaults() {
		return [
			...
			'crel_text_image__text'             => '<p>' . esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa enim esse excepturi nemo nesciunt officia officiis optio.', 'creative-addons-for-elementor' ) . '</p>',
	...
	public function get_presets_options() {
		...
		$options['default'] = array(
			'title' => esc_html__( 'Design 1: Text - Image - Grey Thin', 'creative-addons-for-elementor'),
		...
		$options['design-2'] = array(
			'title' => esc_html__( 'Design 2: Text - Image - Grey Thick', 'creative-addons-for-elementor'),
		...
		$options['design-3'] = array(
			'title' => esc_html__( 'Design 3: Text - Image - Caption + Shadow', 'creative-addons-for-elementor'),
			...
			'options' => array(
				...
				'crel_text_image__caption_text'                     => esc_html__( 'Click on Image to Zoom' , 'creative-addons-for-elementor'),
		...
		$this->start_controls_section(
			...
			$this->add_control_responsive(
				...
				[
					...
					'options'   => [
						'column-reverse'   => esc_html__( 'Image above text', 'creative-addons-for-elementor' ),
						'row-reverse' => is_rtl() ? esc_html__( 'Image right of text', 'creative-addons-for-elementor' ) : esc_html__( 'Image left of text', 'creative-addons-for-elementor' ),
						'column' => esc_html__( 'Image below text', 'creative-addons-for-elementor' ),
						'row'  => is_rtl() ? esc_html__( 'Image left of text', 'creative-addons-for-elementor' ) : esc_html__( 'Image right of text', 'creative-addons-for-elementor' ),
					],
					'separator' => 'before',
					'selectors' => [
	...
	protected function register_style_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control_responsive(
				'crel_text_image__caption_marginTop',
				[
					'label' => esc_html__( 'Space From Image', 'creative-addons-for-elementor'),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'min' => -200,
	...
	protected function render() {
		...
		if ( !empty( $settings['crel_text_image__layout_type'] ) ) {
		...
		<div class="crel-text-image-container <?php echo esc_attr( $layout ); ?>">
			<?php if ( !empty( $settings['crel_text_image__text'] ) ) {
				$this->render_text_column( $settings['crel_text_image__text'] );
			}
			if ( !empty( $settings['crel_text_image__image'] ) ) {
				$this->render_image( $settings['crel_text_image__image'], $settings );
			} ?>
		</div>		<?php
	}
	...
	protected function render_image( $image_data, $settings ) {
		...
		$caption   = $settings['crel_text_image__caption_text'];
		...
		<span style="<?php echo esc_attr( $style ); ?>" class="crel-text-image-img-wrap">
	...
	private function render_text_column( $text ) {
		...
		<div class="crel-text-image-body">
			<div <?php
				...
				echo $this->get_render_attribute_string( 'crel_text_image__text' ); ?>>				<?php
