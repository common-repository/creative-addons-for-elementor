...
class Advanced_Heading extends Creative_Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Advanced Heading', 'creative-addons-for-elementor' );
	}
	...
	protected function get_config_defaults() {
		return [
			...
			// TITLE Section --------------------/
			'crel_advancedHeading__title_text'                          => esc_html__( 'Advanced Heading Title', 'creative-addons-for-elementor' ),
			...
			'crel_advancedHeading__badge_text'                          => esc_html__( 'Version 1.0.0', 'creative-addons-for-elementor' ),
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'crel_advancedHeading__linkId',
				[
					'label' => esc_html__( 'ID', 'creative-addons-for-elementor' ),
					'label_block' => true,
					'type' => Controls_Manager::TEXT,
					'placeholder' => esc_html__( 'my-title', 'creative-addons-for-elementor' ),
					'description' => esc_html__( 'The generated ID for the anchor link is show above. It is based on the initial text of the heading. ' .
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Heading Text', 'creative-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
			...
			$this->add_control(
				...
				[
					...
					'label_block' => true,
					'type' => Controls_Manager::TEXT,
					'placeholder' => esc_html__( 'Type Advanced Heading Title', 'creative-addons-for-elementor' ),
				]
			);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Badge Text', 'creative-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Show Badge', 'creative-addons-for-elementor'),
					'type' => Controls_Manager::SWITCHER,
					'label_on'  => esc_html__( 'Yes', 'creative-addons-for-elementor'),
					'label_off' => esc_html__( 'No', 'creative-addons-for-elementor'),
					'force_preset' => true
			...
			$this->add_control(
				...
				[
					...
					'label_block' => true,
					'type' => Controls_Manager::TEXT,
					'placeholder' => esc_html__( 'Type Badge Text', 'creative-addons-for-elementor' ),
					'condition'	=> [
						'crel_advancedHeading__badge_toggle'	=> 'yes'
					]
				]
	...
	protected function register_style_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'label_block' 	=> false,
					'options' 		=> [
						'crel-advanced-heading--align-left' 	=> is_rtl() ? esc_html__( 'Right', 'creative-addons-for-elementor') : esc_html__( 'Left', 'creative-addons-for-elementor'),
						'crel-advanced-heading--align-right'    => is_rtl() ? esc_html__( 'Left', 'creative-addons-for-elementor') : esc_html__( 'Right', 'creative-addons-for-elementor'),
						'crel-advanced-heading--align-center'   => esc_html__( 'Center', 'creative-addons-for-elementor'),
					]
				]
			);
			...
			$this->add_control_responsive(
				'crel_advancedHeading__containerMiddleDivider_textSpace',
				[
					'label' => esc_html__( 'Divider Space Between Text', 'creative-addons-for-elementor'),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'min' => 0,
			...
			$this->add_control_responsive(
				'crel_advancedHeading__containerMiddleDivider_width',
				[
					'label' => esc_html__( 'Divider Width', 'creative-addons-for-elementor'),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'%' => [
							'min' => 0,
		...
		$this->start_controls_section(
			...
			$this->add_control_group(
				...
				[
					...
					'selector' => '{{WRAPPER}} .crel-advanced-heading-container .crel-advanced-heading__title__text',
				]
			);
		...
		$this->start_controls_section(
			...
			'crel_advancedHeading__anchorLink_padding',
			[
				'label' => esc_html__( 'Margin ( Left / Right )', 'creative-addons-for-elementor'),
				'type' => Controls_Manager::SLIDER,
			...
			$this->add_control(
				...
				[
					...
					'label_block' 	=> false,
					'options' 		=> [
						'crel-advanced-heading--anchorLink-show' 	    => esc_html__( 'Show all the time', 'creative-addons-for-elementor'),
						'crel-advanced-heading--anchorLink-hover'     => esc_html__( 'Show On heading hover', 'creative-addons-for-elementor'),
					],
					'separator'     => 'before'
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'label_block' 	=> false,
					'options' 		=> [
						'crel-advanced-heading--anchorLink-left' 	    => is_rtl() ? esc_html__( 'Right', 'creative-addons-for-elementor') : esc_html__( 'Left', 'creative-addons-for-elementor'),
						'crel-advanced-heading--anchorLink-right'     => is_rtl() ? esc_html__( 'Left', 'creative-addons-for-elementor') : esc_html__( 'Right', 'creative-addons-for-elementor'),
					],
					'condition'	=> [
						'crel_advancedHeading__container_alignment!'	=> 'crel-advanced-heading--align-center'
					]
			...
			$this->add_control_responsive(
				'crel_advancedHeading__anchorLink_topPosition',
				[
					'label' => esc_html__( 'Top Position', 'creative-addons-for-elementor'),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'min' => -1000,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Badge', 'creative-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
			...
			$this->add_control(
				...
				[
					...
					'label_block' 	=> false,
					'options' 		=> [
						'crel-advanced-heading--badge-top' 	   => esc_html__( 'Top', 'creative-addons-for-elementor'),
						'crel-advanced-heading--badge-middle'    => esc_html__( 'Middle', 'creative-addons-for-elementor'),
						'crel-advanced-heading--badge-bottom'    => esc_html__( 'Bottom', 'creative-addons-for-elementor'),
					],
					'condition'	=> [
						'crel_advancedHeading__container_alignment'	=> '!crel-advanced-heading--align-center'
					]
	...
	protected function render_advanced_heading_title(){
		...
		$title_html_tag_escaped = $this->sanitize_html_tag( $settings['crel_advancedHeading__titleHTML_tag'] );
		...
		echo '<div class="crel-advanced-heading__title">' . '<' . esc_attr( $title_html_tag_escaped ) . ' ' . $this->get_render_attribute_string( 'crel_advancedHeading__title_text' ) . '>' .
				esc_html( $title ) . '</' . esc_attr( $title_html_tag_escaped ) . '>';
			//phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			echo $this->render_advanced_heading_link();
		echo '</div>';
	}
	...
	protected function render_advanced_heading_link() {
		...
		$copy_text = esc_html__( 'Copy the URL link to this section to share', 'creative-addons-for-elementor');
		$copied_text = esc_html__( 'Link copied to the clipboard.', 'creative-addons-for-elementor');

		if ( $link_active === 'yes' ) { ?>
			<div class="crel-advanced-heading__title__link" aria-label="<?php echo esc_attr( $copy_text ); ?>" data-copy_text="<?php echo esc_attr( $copy_text ); ?>" data-copied="<?php echo esc_attr( $copied_text ); ?>">
				<div class="crel-advanced-heading__title__link__icon"><?php
					//phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					Icons_Manager::render_icon( $main_icon, [], 'span' ); ?></div>
	...
	protected function render_advanced_heading_badge() {
		...
		if ( $badge_active === 'yes' ) {  ?>
			<div class="crel-advanced-heading__badge">
				<div <?php
				//phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				echo $this->get_render_attribute_string( 'crel_advancedHeading__badge_text' ); ?>> <?php echo esc_html( $badge_text ); ?></div>
			</div>		<?php
		}
	}
	...
	protected function render() {
		...
		<!-- Advanced Heading -->
		<div class="crel-advanced-heading-container <?php echo esc_attr( $main_alignment . ' ' . $icon_position . ' ' . $badge_position . ' ' . $anchorLink_visibility ); ?>">
	...
	protected function render_js_advanced_heading_title() { ?>
		...
		let titleHtmlTag = settings.crel_advancedHeading__titleHTML_tag;
		...
		<div class="crel-advanced-heading__title">
			<{{{titleHtmlTag}}} id="{{{titleID}}}" {{{ view.getRenderAttributeString( 'crel_advancedHeading__title_text' ) }}}>
	...
	protected function render_js_advanced_heading_link() {
		...
		<# if ( settings.crel_advancedHeading__showAnchorLink == 'yes' ) { #>
			...
			<# let iconHTML = elementor.helpers.renderIcon( view, settings.crel_advancedHeading__anchorLink, {}, 'i' , 'object' ); #>
				...
				<div class="crel-advanced-heading__title__link__icon_hover-popup">
					<div class="crel-advanced-heading__title__link__icon_hover-popup__inner">
						<?php echo esc_html( $copy_text ); ?>{{{ settings.crel_advancedHeading__title_text }}}
					</div>
				</div>
			</div>
		<# } #> <?php
