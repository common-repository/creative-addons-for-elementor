...
class KB_Recent_Articles extends Creative_Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'KB Recent Articles', 'creative-addons-for-elementor' );
	}
	...
	protected function get_config_defaults() {
		return [
			...
			'crel_kbRecentArticles__title_text'                         => esc_html__( 'Recent Articles', 'creative-addons-for-elementor' ),
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Articles', 'creative-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_CONTENT
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Order By', 'creative-addons-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'date' => esc_html__( 'Creation Date', 'creative-addons-for-elementor' ),
					'modified' => esc_html__( 'Modification Date', 'creative-addons-for-elementor' ),
				)
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Number of Articles', 'creative-addons-for-elementor' ),
    ...
    protected function register_style_controls() {
	    ...
	    $this->start_controls_section(
		    ...
		    [
			    'label' => esc_html__( 'Article', 'creative-addons-for-elementor' ),
			    'tab' => Controls_Manager::TAB_STYLE,
		    ]
	    );
		    ...
		    $this->add_control(
			    'crel_kbRecentArticles__icon_colorHover',
			    [
				    'label' => esc_html__( 'Icon Hover Color', 'creative-addons-for-elementor' ),
				    'type' => Controls_Manager::COLOR,
				    'selectors' => [
	    ...
	    $this->start_controls_section(
		    ...
		    [
			    'label' => esc_html__( 'Article - Icon', 'creative-addons-for-elementor' ),
			    'tab' => Controls_Manager::TAB_STYLE,
		    ]
	    );
	...
	protected function render() {
	    ...
	    $title                  = $settings['crel_kbRecentArticles__title_text'];
	    $title_html_tag_escaped = $this->sanitize_html_tag( $settings['crel_kbRecentArticles__title_HTMLTag'], 'h3' );
	    $title_active           = $settings['crel_kbRecentArticles__title_toggle'];
	    $layout                 = $settings['crel_kbRecentArticles__list_layout'];
	    $article_icon_loc       = $settings['crel_kbRecentArticles__icon_position'];        ?>

		<div class="crel-kb-article-list-container crel-kb-article-list--<?php echo esc_attr( $layout ) . ' crel-kb-article-list--' . esc_attr( $article_icon_loc ); ?>">
			<div class="crel-kb-article-list__inner"><?php

			    if ( $title_active === 'yes' ) {
				    echo '<' . esc_attr( $title_html_tag_escaped ) . ' class="crel-kb-article-list-title" >' . esc_html( $title ) . '</' . esc_attr( $title_html_tag_escaped ) . '>';
			    }
		        ...
		        if ( empty( $result ) ) {
		            ...
		            foreach( $result as $article ) {
			            ...
			            $article_title_icon = 'crel-recent-articles-icon ep_font_icon_document';
			            ...
			            <!-- List Item -->
			            <li id="<?php echo 'crel-article-' . esc_attr( $article->ID ); ?>" class="crel-kb-article-list-items__item">
