...
class Code_Block extends Creative_Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Code Block', 'creative-addons-for-elementor' );
	}
	...
	protected function get_config_defaults() {
		return [
			...
			'crel_code_block__text' => '//' . esc_html__( 'hello world function', 'creative-addons-for-elementor' ) . '
 function hell_world( $post_type_params ) {             
	...
	public function get_presets_options() {
		...
		$options['crel-default'] = array(
			'title' => esc_html__( 'Standard', 'creative-addons-for-elementor' ),
			'preview_url'   => $this->presets_preview_url( 'code-block-design-1.jpg' ),
			'options' => array()
		);
		
		$options['crel-coy'] = array(
			'title' => esc_html__( 'Coy', 'creative-addons-for-elementor' ),
		...
		$options['crel-fanky'] = array(
			'title' => esc_html__( 'Fanky', 'creative-addons-for-elementor' ),
		...
		$options['crel-okaidia'] = array(
			'title' => esc_html__( 'Okaidia', 'creative-addons-for-elementor' ),
		...
		$options['crel-solarized-light'] = array(
			'title' => esc_html__( 'Solarized Light', 'creative-addons-for-elementor' ),
		...
		$options['crel-codemirror-default'] = array(
			'title' => esc_html__( 'Codemirror Default', 'creative-addons-for-elementor' ),
		...
		$options['crel-blackboard'] = array(
			'title' => esc_html__( 'Blackboard', 'creative-addons-for-elementor' ),
		...
		$options['crel-hopscotch'] = array(
			'title' => esc_html__( 'Hopscotch', 'creative-addons-for-elementor' ),
		...
		$options['crel-dracula-1'] = array(
			'title' => esc_html__( 'Dracula - 1', 'creative-addons-for-elementor' ),
		...
		$options['crel-dracula-2'] = array(
			'title' => esc_html__( 'Dracula - 2', 'creative-addons-for-elementor' ),
		...
		$options['crel-ttcn'] = array(
			'title' => esc_html__( 'TTCN', 'creative-addons-for-elementor' ),
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Header Toolbar', 'creative-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Show Toolbar', 'creative-addons-for-elementor'),
		...
		$this->add_control(
			'crel_code_block__copy_icon',
			[
				'label' => esc_html__( 'Copy Icon', 'creative-addons-for-elementor'),
		...
		$this->add_control(
			'crel_code_block__expand_icon',
			[
				'label' => esc_html__( 'Expand Icon', 'creative-addons-for-elementor'),
				'type' => Controls_Manager::ICONS,
				'description' => esc_html__( 'Icon will be hidden if the Code Block has no height limit.', 'creative-addons-for-elementor'),
				'fa4compatibility' => 'icon',
				'condition'	=> [
					'crel_code_block__toolbar_toggle'	=> 'yes'
				]
		...
		$this->start_controls_section(
			'crel_code_block__general_section_controls',
				[
					'label' => esc_html__( 'Code', 'creative-addons-for-elementor' ),
					'tab' => Controls_Manager::TAB_CONTENT
				]
			);
			...
			$this->add_control(
				...
				[
					'label'     => esc_html__( 'Language', 'creative-addons-for-elementor' ),
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Line Numbers', 'creative-addons-for-elementor'),
					'type' => Controls_Manager::SWITCHER,
					'label_on'  => esc_html__( 'Yes', 'creative-addons-for-elementor'),
					'label_off' => esc_html__( 'No', 'creative-addons-for-elementor'),
					//'force_preset' => true
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'First Line Number', 'creative-addons-for-elementor'),
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Line Highlight', 'creative-addons-for-elementor' ),
					'label_block' => true,
					'type' => Controls_Manager::TEXT,
					'description' => esc_html__( 'Enter line numbers. Examples: 5 (5th line), 1-5 (lines 1 to 5)', 'creative-addons-for-elementor' ),
				]
			);
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Line Wrap', 'creative-addons-for-elementor'),
					'type' => Controls_Manager::SWITCHER,
					'label_on'  => esc_html__( 'Yes', 'creative-addons-for-elementor'),
					'label_off' => esc_html__( 'No', 'creative-addons-for-elementor'),
					'selectors' => [
	...
	protected function register_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Language Header', 'creative-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'crel_code_block__toolbar_toggle'	=> 'yes'
				]
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crel-code-block-header-container' => 'color: {{VALUE}}; fill: {{VALUE}};'
				],
				'condition' => [
					'crel_code_block__toolbar_toggle'	=> 'yes'
				]
		...
		$this->start_controls_section(
			...
			$this->add_control_responsive(
				'crel_code_block__code_max_height',
				[
					'label' => esc_html__( 'Block Max Height', 'creative-addons-for-elementor' ),
					'description' =>  esc_html__( 'Leave blank for no height limit.', 'creative-addons-for-elementor' ),
					'type' => Controls_Manager::SLIDER,
					'size_units' => ['px'],
					'range' => [
						'px' => [
	...
	protected function render() {
		...
		$language_name = $settings['crel_code_block__language'];

		if ( $language_name == 'php-wordpress' ) {
			$language_name = 'php';
			$block_shortcodes = !Utilities_Plugin::elementor_is_edit_mode();
		...
		if ( $settings['crel_code_block__toolbar_toggle'] == 'yes' ) {
			...
			if ( isset( $language_list[$language_name] ) && ! $language_title) {
				$language_title = $language_list[$language_name];
			}
		}

		$copy_icon = $settings['crel_code_block__copy_icon'];
		$expand_icon = $settings['crel_code_block__expand_icon'];
		$show_expand = Utilities_Plugin::elementor_is_edit_mode() || ( isset( $settings['crel_code_block__code_max_height']['size'] ) && $settings['crel_code_block__code_max_height']['size'] !== '' );


		$line_highlight_escaped = $settings['crel_code_block__line_highlight'] ? 'data-line="' . esc_attr( $settings['crel_code_block__line_highlight'] ) . '"' : '';
		$line_numbers = $settings['crel_code_block__line_numbers'] == 'yes' ? 'line-numbers' : '';
		$start_line_escaped = $line_numbers && $settings['crel_code_block__line_numbers_start'] !== '' ? 'data-start="' . esc_attr( $settings['crel_code_block__line_numbers_start'] ) . '"' : '';
		...
		$language = $language_name . ' ' . ( $settings['crel_Generic__Presets'] ?: 'crel-default' ); ?>
		
		<div class="<?php echo esc_attr( $line_numbers ); ?> crel-code-block-container crel-loading language-<?php echo esc_attr( $language ); ?>" data-language_title="<?php echo esc_attr( $language_title ); ?>"><?php
			if ( $language_title ) { ?>

				<div class="crel-code-block-header-container">
					<div class="crel-code-block__title"><?php echo esc_html( $language_title ); ?></div>
					<div class="crel-code-block__control-panel">
						<div class="crel-code-block__control-panel__help-text"></div>
						
						<div class="crel-code-block__control-copy" data-help="<?php esc_html_e( 'Copy', 'creative-addons-for-elementor' ); ?>" data-copied="<?php esc_html_e( 'Copied!', 'creative-addons-for-elementor' ); ?>"><?php
							Icons_Manager::render_icon( $copy_icon ); ?>
						</div><?php 
						
						if ( $show_expand ) { ?>
							<div class="crel-code-block__control-expand" data-help="<?php esc_html_e( 'Expand', 'creative-addons-for-elementor' ); ?>"><?php
								Icons_Manager::render_icon( $expand_icon ); ?>
							</div><?php 
						} ?>
			...
			<pre <?php echo $line_highlight_escaped . ' ' . $start_line_escaped; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
				<code class="match-braces <?php echo $block_shortcodes ? 'crel-replace-brackets' : ''; ?>"><?php echo wp_kses_post( $code ); ?></code>
			</pre>
			<textarea class="crel-block-original-code"><?php echo wp_kses_post( $code ); ?></textarea>
		</div>		<?php
	}
	...
	protected function content_template() { ?>
		<#
			...
			if ( settings.crel_code_block__toolbar_toggle == 'yes' ) {
				let language_list = <?php echo wp_json_encode( $this->get_languages() ); ?>;
		...
		<# if ( language_title ) { #>
				...
				<div class="crel-code-block-header-container">
					...
					<div class="crel-code-block__control-panel">
						<div class="crel-code-block__control-panel__help-text"></div>
						<div class="crel-code-block__control-copy" data-help="<?php esc_html_e( 'Copy', 'creative-addons-for-elementor' ); ?>" data-copied="<?php esc_html_e( 'Copied!', 'creative-addons-for-elementor' ); ?>">
							{{{ elementor.helpers.renderIcon( view, settings.crel_code_block__copy_icon ) }}}
						</div>
						
						<div class="crel-code-block__control-expand" data-help="<?php esc_html_e( 'Expand', 'creative-addons-for-elementor' ); ?>">
