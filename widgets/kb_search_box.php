...
class KB_Search_Box extends Creative_Widget_Base {
	...
	public function get_title() {
		return esc_html__('KB Search', 'creative-addons-for-elementor');
	}
	...
	protected function get_config_defaults() {
		...
		return [
			...
			'crel_kbSearchBox__title_text'                                  => esc_html__( 'How can we Help?', 'creative-addons-for-elementor' ),
			'crel_kbSearchBox__title_HTMLTag'                               => 'h3',
			'crel_kbSearchBox__inputPlaceholder_text'                       => esc_html__('Have a question? Enter a search term.', 'creative-addons-for-elementor'),
			...
			'crel_kbSearchBox__Button_Text'                                 => esc_html__('Search', 'creative-addons-for-elementor'),
			...
			'crel_kbSearchBox__allResults_text'                             => esc_html__('See All Results', 'creative-addons-for-elementor'),
			'crel_kbSearchBox__helpText_text'                               => esc_html__('Could not find your question? Contact us here.', 'creative-addons-for-elementor'),
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Search', 'creative-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_CONTENT
			]);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Placeholder', 'creative-addons-for-elementor'), 
				'label_block' => true, 
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__('Have a question? Enter a search term.', 'creative-addons-for-elementor'),
			]);
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true, 
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__('Search', 'creative-addons-for-elementor'), 
		...
		$this->start_controls_section(
				...
				[
					'label' => esc_html__('Results', 'creative-addons-for-elementor'),
					'tab' => Controls_Manager::TAB_CONTENT
				]);
		...
		$this->add_control(
				...
				[
					'label' => esc_html__('Size of Search Results List',
		...
		$this->add_control(
				...
				[
					'label' => esc_html__('All Results Text', 'creative-addons-for-elementor'), 
					'label_block' => true, 'type' => Controls_Manager::TEXT,
					'placeholder' => esc_html__('See All Results', 'creative-addons-for-elementor'),
				]);
		...
		$this->add_control(
				...
				[
					'label' => esc_html__('Show Help Text', 'creative-addons-for-elementor'),
					'type' => Controls_Manager::SWITCHER, 'label_on' => esc_html__('Yes', 'creative-addons-for-elementor'),
					'label_off' => esc_html__('No', 'creative-addons-for-elementor'), 'separator' => 'before',
				]);
		...
		$this->add_control(
				...
				[
					'label' => esc_html__('Help Text', 'creative-addons-for-elementor'), 
					'label_block' => true, 'type' => Controls_Manager::TEXT,
					'placeholder' => esc_html__('Could not find your question?, contact us here.', 
						'creative-addons-for-elementor'), 
					'condition' => [
		...
		$this->add_control(
				'crel_kbSearchBox__HelpURL',
				[
					'label' => esc_html__('Help Link URL', 'creative-addons-for-elementor'),
					'type' => Controls_Manager::URL,
					'label_block' => true,
					'placeholder' => esc_html__('Enter link URL', 'creative-addons-for-elementor'),
					'show_external' => true,
					'condition' => [
						'crel_kbSearchBox__showHelpText_toggle' => 'yes'
					]
	...
	protected function register_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Input / Button Container', 'creative-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Input', 'creative-addons-for-elementor'), 
				'tab' => Controls_Manager::TAB_STYLE,
			]);
		...
		$this->start_controls_tabs( '_tabs_button' );
			...
			$this->start_controls_tab(
				...
				[
					'label' => esc_html__('Focus', 'creative-addons-for-elementor'),
				]);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Button / Icon ', 'creative-addons-for-elementor'), 
				'tab' => Controls_Manager::TAB_STYLE,
			]);
		...
		$this->start_controls_tab(
			...
			$this->add_control(
				...
				[
					'label' => esc_html__('Icon/Text Color', 'creative-addons-for-elementor'),
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .crel-search-box__search-form__submit' => 'color: {{VALUE}}; fill: {{VALUE}};',
					],
				]);
			...
			$this->add_control_responsive(
				'crel_kbSearchBox__button_width',
				[
					'label' => esc_html__('Button Width', 'creative-addons-for-elementor'),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'min' => 20,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Search Results - General', 'creative-addons-for-elementor'), 
				'tab' => Controls_Manager::TAB_STYLE,
			]);
		...
		$this->add_control_responsive(
			'crel_kbSearchBox__searchResults_maxHeight',
			[
				'label' => esc_html__('Max Height', 'creative-addons-for-elementor'), 
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 200, 
		...
		$this->add_control_responsive(
			'crel_kbSearchBox__searchResults_margin',
			[
				'label' => esc_html__('Container Margin', 'creative-addons-for-elementor'), 
				'type' => Controls_Manager::DIMENSIONS, 
				'size_units' => [
					'px',
					'em',
		...
		/*	$this->add_control_responsive(
				'crel_kbSearchBox__SearchResults_Zindex',
				[
					'label' => esc_html__( 'Z-Index', 'creative-addons-for-elementor'),
					'type' => Controls_Manager::SLIDER,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Search Results - List Items', 'creative-addons-for-elementor'), 
				'tab' => Controls_Manager::TAB_STYLE,
			]);
		...
		$this->add_control_responsive(
			'crel_kbSearchBox__SearchResultsIcon_padding', 
			[
				'label' => esc_html__('Icon Padding', 'creative-addons-for-elementor'), 
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [
					'px', 
					'em', 
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Search Results - All Results Text', 'creative-addons-for-elementor'), 
				'tab' => Controls_Manager::TAB_STYLE,
			]);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Search Results - Help Text', 'creative-addons-for-elementor'), 
				'tab' => Controls_Manager::TAB_STYLE,
			]);
	...
	protected function render() {
		...
		// TITLE ---------------------------/
		$title = $settings['crel_kbSearchBox__title_text'];
		$title_html_tag_escaped = $this->sanitize_html_tag( $settings['crel_kbSearchBox__title_HTMLTag'], 'h3' );
		$title_active = $settings['crel_kbSearchBox__title_toggle'];

		// INPUT -----------------------------------/
		$input_placeholder = $settings['crel_kbSearchBox__inputPlaceholder_text'];

		// BUTTON ----------------------------------/
		$button_type = $settings['crel_kbSearchBox__button_type'];
		$button_text = $settings['crel_kbSearchBox__Button_Text'];
		$button_icon = $settings['crel_kbSearchBox__button_icon']; // this is an array

		// SEARCH RESULTS --------------------------/
		$article_icon_loc = $settings['crel_kbSearchBox__searchResults_iconPosition'];
		$all_results_text = $settings['crel_kbSearchBox__allResults_text'];
		$all_results_size = $settings['crel_kbSearchBox__allResults_size'];

		$kb_id = $this->get_current_kb_id(); ?>

		<!-- Search Form -->
		<div class="crel-search-box-container crel-search-box--<?php echo esc_attr( $article_icon_loc ); ?>">

			<!-- Search Title -->			<?php
			if ( $title_active === 'yes' ) {
				echo '<' . esc_attr( $title_html_tag_escaped ) . ' class="crel-search-box__title" >' . esc_html( $title ) . '</' . esc_attr( $title_html_tag_escaped ) . '>';
			}			?>

			<form class="crel-search-box__search-form" role="search" action="" method="get">

				<div class="crel-search-box__search-form__inner">
					<input type="hidden" name="crel_kb_id" value="<?php echo esc_attr( $kb_id ); ?>"/>
					<input type="hidden" name="crel_ajaxurl" value="<?php echo esc_url( admin_url('admin-ajax.php', 'relative') ); ?>"/>
					<input type="hidden" name="crel_list_size" value="<?php echo esc_attr( $all_results_size ); ?>"/>
					<input placeholder="<?php echo esc_attr( $input_placeholder ); ?>" class="crel-search-box__search-form__input" type="search" name="crel-search-widget" title="Search" value>
					<div class="crel-loading-spinner" style="display: none;"></div><?php 
						if ( $button_type === 'text' ) { ?>
							<button class="crel-search-box__search-form__submit" type="submit" title="Search" aria-label="Search"><?php echo esc_html( $button_text ); ?></button><?php
						} else { ?>
							<button class="crel-search-box__search-form__submit" type="submit" title="Search" aria-label="Search">	<?php
							   \Elementor\Icons_Manager::render_icon( $button_icon, [ 'aria-hidden' => 'true' ] ); ?>
								<span class="crel-screen-only"><?php echo esc_html( $button_text ); ?></span>
							  </button><?php 
						} ?>
				</div>
			...
			<div class="crel-search-box__search-results-container">
				...
				<div class="crel-search-box__search-results">
					...
					<div class="crel-sbsr__all-results">
						<a href="#"><?php echo esc_html( $all_results_text ); ?></a>
					</div>
	...
	private function render_help_text( $settings ) {
		...
		if ( $help_text__toggle === 'yes' ) {
			$help_text = $settings['crel_kbSearchBox__helpText_text'];
			...
			<div class="crel-sbsr__help-text">
				<a href="<?php echo esc_url( $help_text__url ); ?>" target="<?php echo esc_url( $help_text__url_external ); ?>" rel="<?php echo esc_url( $help_text__url_nofollow ); ?>">
					<span class="crel-sbsr__help-text__text"><?php echo esc_html( $help_text ); ?></span>
				</a>
			</div>        <?php
		}
	}
	...
	protected function content_template() {
		...
		<div class="crel-search-box-container crel-search-box--{{{ settings.crel_kbSearchBox__searchResults_iconPosition }}}">
			...
			let titleHtmlTag = settings.crel_kbSearchBox__title_HTMLTag;
			...
			if ( settings.crel_kbSearchBox__title_toggle == 'yes' ) { #>
				<{{{ titleHtmlTag }}} class="crel-search-box__title">{{{ settings.crel_kbSearchBox__title_text }}}</{{{ titleHtmlTag }}}>
			<# } #>
