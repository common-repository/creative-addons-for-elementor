...
class Creative_Preset extends \Elementor\Control_Select {
	...
	public function content_template() {
		...
		<div class="elementor-control-field {{{ data.reset ? 'crel-with-reset' : '' }}} {{{ ( data.select_class ) ? data.select_class : '' }}}"><#
			...
			<div class="elementor-control-input-wrapper"><#
				if ( data.reset ) { #>
					<i title="<?php esc_html_e( 'Reset Style', 'creative-addons-for-elementor' ); ?>" class="eicon-redo crel-reset-design" aria-hidden="true"></i><#
				} #>
	...
	public function enqueue() {
		...
		wp_localize_script( 'creative_preset', 'creative_preset_vars', array(
								...
								'select_preset_title' => esc_html__( 'Select Custom Preset', 'creative-addons-for-elementor' ),
