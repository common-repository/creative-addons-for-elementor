...
function crel_add_plugin_action_links ( $links ) {
	$my_links = array(
		__( 'Configuration', 'creative-addons-for-elementor' )    => '<a href="' .  esc_url( admin_url( 'admin.php?page=creative-addons&tab=widgets' ) ) . '">' . esc_html__( 'Settings', 'creative-addons-for-elementor' ) . '</a>',
	);
